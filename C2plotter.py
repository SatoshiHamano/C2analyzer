            ...
            for line in C2band[i]:
                if lowlim < line.lamair < upplim:
                    ...
                    plt.text(line.lamair * vf + textxshift, ycoord[i] + marklen + textyshift, line.rotJ,
                             fontname="Arial", fontsize=7, va="bottom", ha="center")
...
if __name__ == "__main__":
    ...
    xlim = {bandlist[0]: [12060, 12160, 12300], bandlist[1]: [10120, 10260, 10400]}
    ylim = [0.75, 1.15]
    thres = 0.6
    ...
    if oneflag:
        ...
        spectrum_plot(ax1, [telx], [tely], [xlim[band][0], xlim[band][1]], [0.0, 1.1], xaxis_label="Wavelength ($\AA$)",
                      yaxis_label="Transmittance", yticks_val=[0., 0.5, 1.0], linew=[1.], colors=["0.3"])
        ...
        spectrum_plot(ax2, [spx, spx], [spy, spy_mask], [xlim[band][0], xlim[band][1]], ylim, colors=["0.8", "k"],
                      ...
                      yticks_val=[0.8, 0.9, 1.0, 1.1], yticks_label=[0.8, 0.9, 1.0, 1.1], yaxis_label="Normalized flux")
